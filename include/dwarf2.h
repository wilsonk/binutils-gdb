...
enum dwarf_source_language
  {
    ...
    DW_LANG_Zig = 0x0015,
    /* DWARF 5.  */
    DW_LANG_OpenCL = 0x0016,
    DW_LANG_Go = 0x0017,
    DW_LANG_Modula3 = 0x0018,
    DW_LANG_Haskell = 0x0019,
    DW_LANG_C_plus_plus_03 = 0x001a,
    DW_LANG_C_plus_plus_11 = 0x001b,
    DW_LANG_OCaml = 0x001c,
    DW_LANG_Rust = 0x001d,
    DW_LANG_C11 = 0x001e,
    DW_LANG_Swift = 0x001f,
    DW_LANG_Julia = 0x0020,
    DW_LANG_Dylan = 0x0021,
    DW_LANG_C_plus_plus_14 = 0x0022,
    DW_LANG_Fortran03 = 0x0023,
    DW_LANG_Fortran08 = 0x0024,
    DW_LANG_RenderScript = 0x0025,
